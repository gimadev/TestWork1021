...
Route::group([
    ...
    Route::delete('roles', [RoleController::class, 'delete'])->middleware('permission:edit_role');
    ...
    Route::put('users', [UserController::class, 'update'])->middleware('permission:edit_role');
});
